---
title: "Quickstart"
description: "Get started with the Kisho SDK in under 5 minutes"
---
...
`bash
    ...
    `
Then, load these environment variables in your Python script:
...
os.environ['KISHO_API_KEY'] = os.getenv('KISHO_API_KEY')
```
